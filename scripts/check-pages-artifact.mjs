...
if (!worker.includes('"./manifest.webmanifest"') || !worker.includes('"./icons/vibe-up-192.png"') || !worker.includes('"./icons/cursor-select.svg"') || !worker.includes('"./icons/cursor-pushpull.svg"')) {
